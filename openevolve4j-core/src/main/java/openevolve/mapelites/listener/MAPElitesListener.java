...
/**
 * Listener interface for tracking various events during MAP-Elites algorithm execution. Provides
 * hooks for monitoring, logging, and extending algorithm behavior.
 */
public interface MAPElitesListener<T> extends Listener {
     ...
     */
    default void onSolutionSelection(java.util.List<Solution<T>> selectedSolutions, Island island,
            int iteration) {}
     ...
     * @param iteration current iteration
     */
    default void onSolutionGenerated(Solution<T> newSolution, java.util.List<Solution<T>> parents,
            int iteration) {}
    ...
    /**
     * Called when a solution successfully improves a cell (replaces existing solution or fills
     * empty cell).
     *
     ...
     * @param iteration current iteration
     */
    default void onCellImproved(Solution<T> newSolution, Solution<T> previousSolution, Cell cell,
            int iteration) {}
     ...
     * @param iteration current iteration
     */
    default void onCellRejected(Solution<T> candidateSolution, Solution<T> existingSolution,
